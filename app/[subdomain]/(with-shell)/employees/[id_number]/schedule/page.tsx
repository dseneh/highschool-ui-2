...
export default function EmployeeSchedulePage() {
  ...
  const { data: employee, isLoading: employeeLoading, error, refetch, isFetching } = employeeApi.getEmployeeMember(idNumber, {
  ...
  if (employeeLoading) return <ScheduleSkeleton />
  ...
  return (
    <PageLayout
      ...
      // emptyStateTitle={!employee.is_teacher ? "Not a Teacher" : "No Schedule Entries"}
      // emptyStateDescription={!employee.is_teacher
      //   ? "This employee is not marked as a teaching staff."
