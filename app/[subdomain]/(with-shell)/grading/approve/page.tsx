...
export default function ApproveGradesPage() {
  ...
  const getStatusBadge = (status: string) => {
    const statusMap: Record<string, { variant: "default" | "secondary" | "outline", label: string }> = {
      [GradeStatus.REVIEWED]: { variant: "secondary", label: "Reviewed" },
      [GradeStatus.APPROVED]: { variant: "default", label: "Approved" },
    };
  ...
  return (
    <PageLayout
      ...
      description="Final approval of reviewed gradebooks (Admin only)"
      loading={isLoading}
      noData={
      ...
      emptyState={
        <EmptyState>
          ...
          <EmptyStateDescription>
            {sectionFilter
              ? "No gradebooks are awaiting approval for this section"
