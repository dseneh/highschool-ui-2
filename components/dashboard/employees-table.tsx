...
export function EmployeesTable({ employees = [] }: { employees?: EmployeeDto[] }) {
  ...
  const filteredEmployees = React.useMemo(() => {
    return employees.filter((emp) => {
      ...
      const matchesSearch =
        ...
        empNumber.toLowerCase().includes(searchQuery.toLowerCase());
  ...
  React.useEffect(() => {
    setCurrentPage(1);
  }, [employees, searchQuery, departmentFilter, statusFilter, pageSize]);
    ...
    <div className="rounded-xl border bg-card overflow-hidden">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-5 py-4 border-b">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-[200px]">
              ...
              <DropdownMenuGroup>
                ...
                {["all", "Active", "On Leave", "Probation", "Terminated", "Inactive"].map(
                  (status) => (
                    <DropdownMenuCheckboxItem
                      key={status}
          ...
          <Button variant="outline" icon={<HugeiconsIcon icon={FileImportIcon} />}>
            Import
          </Button>
        </div>
      </div>
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-muted/50 hover:bg-muted/50">
              ...
              <TableHead className="hidden lg:table-cell min-w-[120px] text-muted-foreground font-medium">
                Type
              </TableHead>
              ...
              paginatedEmployees.map((employee) => {
                ...
                return (
                  <TableRow
                    ...
                    onClick={() => router.push(`/${subdomain}/employees/${employee.id}`)}
                  >
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2.5">
                        ...
                        <span className="font-medium">{displayName || "Unnamed"}</span>
                      </div>
                    </TableCell>
