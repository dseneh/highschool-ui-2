...
import { GradeLevelDistribution } from "@/lib/api2/dashboard";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
...
export function GradeLevelChart({
  data = [],
  isLoading = false,
}: {
      ...
      <div className="rounded-xl border border-border bg-card p-5">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <h3 className="font-medium">Grade Level Distribution</h3>
          </div>
        </div>
    ...
    <div className="rounded-xl border border-border bg-card p-5">
      ...
      <div className="flex flex-col min-[520px]:flex-row min-[520px]:items-end min-[520px]:justify-between lg:flex-col lg:items-stretch xl:flex-row xl:items-end xl:justify-between gap-4">
        ...
        <div className="space-y-4">
          <div>
            <p className="text-sm text-muted-foreground mb-1">Average per Grade</p>
            <p className="text-3xl font-semibold tracking-tight">{avgStudents}</p>
          </div>
