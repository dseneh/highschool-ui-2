...
export function PayrollsSidebar({
  ...
  return (
    <Sidebar className="lg:border-r-0!" collapsible="none" {...props}>
      <SidebarHeader className="pb-0">
        <div className="px-2 py-3">
          <div className="flex items-center justify-between">
            <DropdownMenu>
              <DropdownMenuTrigger>
                <span className="flex w-full items-center justify-between gap-3 rounded-md px-1.5 py-1 hover:bg-muted/60">
        ...
        <SidebarGroup>
          <SidebarGroupContent>
            <Link
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-md border border-border bg-background px-3 py-2 text-sm font-medium hover:bg-muted transition-colors"
            >
