  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-2 sm:gap-x-6">
      <div className="flex w-full flex-col gap-2 sm:w-fit sm:flex-row sm:items-center">
        {table.getColumn("status")?.getIsVisible() && statuses.length > 0 && (
          <DataTableFilter
        ...
        {table.getColumn("region")?.getIsVisible() && regions.length > 0 && (
          <DataTableFilter
        ...
        {table.getColumn("costs")?.getIsVisible() && conditions.length > 0 && (
          <DataTableFilter
