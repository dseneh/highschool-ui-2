 ...
 *
 * Pass `items` so `<SelectValue>` displays the **label** instead of the raw
 * value (useful when item values are IDs).
 *
 * Base UI natively supports:
 *   items={[{ value: "uuid-1", label: "Savings" }, …]}
 *   items={{ uuid1: "Savings", uuid2: "Checking" }}
 */
