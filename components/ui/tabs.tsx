...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(tabsListVariants({ variant }), className, "py-5")}
      {...props}
    />
  )
}
